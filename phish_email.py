#Neural Network to predict future emails as phishing or not
...
def splitData(data):
    ...
    perc = np.random.rand(len(data)) < 0.8
    training = data[perc]
    testing = data[~perc]
...
#  hidden_3 = tf.nn.relu(tf.add(tf.matmul(hidden_2, W_hidden_3), bias_hidden_3))
  ...
  output.to_csv("testing_126.csv")
  # Add ops to save and restore all the variables.

  save_path = saver.save(sess, "~/Desktop/Capital\ Group/tmp/model.ckpt")
